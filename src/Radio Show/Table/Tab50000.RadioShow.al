...
table 50000 "Radio Show"
{
    ...
    fields
    {
        ...
        field(160; "Radio Frequency"; Enum "Radio Frequency")
        {
        ...
        field(250; "Avg. Listeners"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = Average("Listener Ledger".Listeners where(Date = Field("Date Filter")));
        }
        field(260; "Avg. Listener Share"; Decimal)
        {
            Caption = 'Avg. Listener Share';
            FieldClass = Flowfield;
            CalcFormula = Average("Listener Ledger"."Listener Share" where(Date = field("Date Filter")));
        }
